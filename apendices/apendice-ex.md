---
title: "APÊNDICE EX — APRESENTAÇÃO E FALA EM PÚBLICO"
appendix: "EX"
---
...
A estrutura narrativa do pitch é coberta em [[apendice-v|Apêndice V]]. Aqui, o foco é o delivery: como apresentar o mesmo deck de forma diferente para audiências diferentes, e o que fazer nos momentos críticos da reunião.
...
> **Slides cheios de texto que o apresentador lê em voz alta.** O slide é para a audiência; se o apresentador lê, a audiência não precisava do apresentador. **Abrir com apresentação pessoal longa.** "Bom dia, eu sou X, trabalho com Y há Z anos, comecei minha carreira em..." — você perdeu os primeiros 30 segundos e a atenção de quem veio pelo conteúdo, não pela biografia. **Responder pergunta hostil com defensividade.** A defensividade é lida como confirmação de que a crítica tem fundamento. **Improvisar apresentação importante sem ensaio adequado.** "Conheço o material de cor" não é o mesmo que "ensaiei a apresentação três vezes." O conteúdo e a entrega são habilidades diferentes. **Não olhar para a câmera em vídeo.** Em call de pitch, board ou cliente, olhar para o rosto da pessoa na tela em vez da câmera elimina contato visual real. **Fazer all-hands só com boas notícias.** Time que nunca ouve problemas reais em all-hands para de acreditar no que o fundador diz no all-hands.
...
[[apendice-ew|Apêndice EW — Comunicação Escrita]], [[apendice-ek|Apêndice EK — Influência]], [[apendice-ev|Apêndice EV — Comunicação em Crise]], [[apendice-v|Apêndice V — Captação e Pitch]]
