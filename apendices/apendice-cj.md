---
title: "APÊNDICE CJ — TOKENIZAÇÃO PARA FOUNDERS: ATIVOS DIGITAIS, SECURITY TOKENS E QUANDO NÃO É HYPE"
appendix: "CJ"
---
...
> Frequentemente é vendido como se resolvesse cinco coisas. Valuation. O token não "descobre preço" em ativo ilíquido. Negociação continua difícil. Liquidez em ativo sem demanda. Tokenizar imóvel em local sem compradores não cria compradores. Regulatório. Security token ainda é security (valor mobiliário). Está sujeito a regras tradicionais de mercado de capitais. Governança de empresa. Assembleias, votação, e conflitos. Tudo continua existindo. Só com interface digital. Descentralização de risco. O risco de operação continua no emissor. Blockchain não garante performance do ativo subjacente.
