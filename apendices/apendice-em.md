---
title: "APÊNDICE EM — COMPLIANCE E ANTICORRUPÇÃO PARA STARTUPS"
appendix: "EM"
---
...
- [[apendice-cv|Apêndice CV — Segurança da Informação: Da Certificação à Engenharia]] — complementa a LGPD com a dimensão técnica de proteção de dados
- [[apendice-ck|Apêndice CK — Governança Corporativa]] — conselhos, conselheiros independentes e o papel do board em compliance
- [[apendice-cn|Apêndice CN — Estrutura Jurídica e Societária]] — CNPJ, escolha de tipo societário e implicações para responsabilidade
- [[fases/fase-14|Fase 14 — Escala e Governança]] — quando compliance entra na agenda estratégica do crescimento
- [[fases/fase-16|Fase 16 — Saída e Liquidez]] — due diligence de M&A e IPO onde o histórico de compliance é auditado
