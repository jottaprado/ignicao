---
title: "APÊNDICE CG — GROWTH COMO FUNÇÃO ORGANIZACIONAL: TIME DE GROWTH, BUILD VS HIRE, RELAÇÃO COM PRODUTO"
appendix: "CG"
---
...
------------------------------------------------------
Fontes: benchmarks agregados de fundos BR, Distrito, ABStartups
```
...
[[apendice-cp|Apêndice CP]], Sales B2B, SMB e PLG. [[apendice-ao|Apêndice AO]], Dados e experimentação. [[apendice-ay|Apêndice AY]], Marketing de performance.
