---
title: "APÊNDICE EQ — DIREITO DO CONSUMIDOR E CDC PARA STARTUPS"
appendix: "EQ"
---
...
A Política de Privacidade é complementar ao Termo de Uso e tem superposição com a LGPD (ver [[apendice-ep|Apêndice EP — LGPD para Startups]]). O CDC exige transparência sobre coleta e uso de dados — qualquer uso de dados pessoais para fins que o consumidor não esperaria ao contratar configura prática abusiva.
...
- [[apendice-ep|Apêndice EP — LGPD para Startups]] — proteção de dados pessoais e interface com o CDC
- [[apendice-er|Apêndice ER — Contratos Digitais e Validade Jurídica]] — Termos de Uso, assinatura eletrônica e validade probatória
- [[apendice-es|Apêndice ES — Propriedade Intelectual para Startups]] — proteção de marca e software
- [[fases/fase-03|Fase 3 — Validação com Clientes Reais]] — momento em que a relação de consumo se inicia de fato
- [[fases/fase-05|Fase 5 — Produto e Operação]] — implementação de compliance operacional no produto
