---
title: "APÊNDICE CZ — CANVASES E MAPAS VISUAIS DE MODELO"
appendix: "CZ"
---
...
flowchart TB
    subgraph BMC["Business Model Canvas"]
        direction LR
        subgraph Esquerda["Engrenagens"]
            P["Parcerias-Chave"]
            A["Atividades-Chave"]
            R["Recursos-Chave"]
        end
        subgraph Centro["Valor"]
            V["Proposta<br/>de Valor"]
        end
        subgraph Direita["Frente"]
            REL["Relacionamento<br/>com Clientes"]
            C["Canais"]
            S["Segmentos<br/>de Clientes"]
        end
        subgraph Base["Economia"]
            CO["Estrutura de Custos"]
            REC["Fontes de Receita"]
        end
    end
    P --> V
    A --> V
...
```mermaid
flowchart TB
    subgraph Lean["Lean Canvas — diferenças do BMC em destaque"]
        direction LR
        subgraph Esquerda["Apostas a validar"]
            PB["Problema<br/>(antes: Parcerias)"]
            SOL["Solução<br/>(antes: Atividades)"]
            M["Métricas-Chave<br/>(antes: Recursos)"]
        end
        subgraph Centro["Diferencial"]
            UVP["Proposta Única<br/>de Valor"]
            VI["Vantagem Injusta<br/>(antes: Relacionamento)"]
        end
        subgraph Direita["Mercado"]
            C["Canais"]
            S["Segmentos<br/>de Clientes"]
        end
    end
...
```mermaid
flowchart LR
    subgraph CP["Customer Profile (lado direito)"]
        direction TB
        J["📋 Jobs<br/>O que o cliente<br/>tenta fazer"]
        P["⚠️ Pains<br/>Frustrações,<br/>riscos, obstáculos"]
        G["✨ Gains<br/>Benefícios<br/>esperados"]
    end
    subgraph VM["Value Map (lado esquerdo)"]
        direction TB
        PR["💊 Pain Relievers<br/>Como o produto<br/>reduz os pains"]
        PS["📦 Products & Services<br/>O que você<br/>oferece"]
        GC["🎁 Gain Creators<br/>Como o produto<br/>produz os gains"]
    end
    PR -.encaixa.-> P
    GC -.encaixa.-> G
    PS -.responde.-> J
