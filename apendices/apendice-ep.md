---
title: "APÊNDICE EP — RESPONSABILIDADE DO SÓCIO E DO ADMINISTRADOR"
appendix: "EP"
---
...
- Na [[fases/fase-01|Fase 1 (constituição)]], a escolha do tipo societário e do regime de integralização já define o ponto de partida da exposição pessoal.
- No [[apendice-es|Apêndice ES — Estrutura Societária]], está o detalhamento de LTDA vs. SA vs. SAS e como o tipo societário afeta a responsabilidade.
- No [[apendice-fi|Apêndice FI — Finanças para Fundadores]], a separação de caixas PF/PJ é tratada como princípio de gestão financeira, não apenas como requisito jurídico.
- No [[apendice-dd|Apêndice DD — Due Diligence para Captação]], o passivo pessoal dos fundadores aparece como item de checklist do processo de verificação pré-investimento.

---

**Ver também:**

- [[apendice-es|Apêndice ES — Estrutura Societária e Tipos de Empresa no Brasil]]
- [[apendice-fi|Apêndice FI — Finanças para Fundadores]]
- [[apendice-dd|Apêndice DD — Due Diligence para Captação]]
- [[apendice-tr|Apêndice TR — Tributação da Startup Brasileira]]
- [[fases/fase-01|Fase 1 — Constituição e Formalização]]
- [[fases/fase-14|Fase 14 — Escala e Estruturação Organizacional]]
