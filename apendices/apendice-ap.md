---
title: "APÊNDICE AP — CULTURA COMO DISCIPLINA"
appendix: "AP"
---
...
#### 8. Cultura em times remotos e híbridos
...
> Frequência de mensagens não é indicador de saúde cultural. Times podem ter canais muito ativos com clima profundamente fragmentado. A questão não é volume de comunicação. É qualidade do vínculo, clareza de valores, e se as pessoas tomam decisões difíceis de forma consistente com o que a empresa declara que importa.
...
#### 9. Cultura em hipercrescimento: o que quebra quando o time dobra
...
#### 10. Padrões de cultura tóxica: diagnóstico e intervenção
...
#### 11. Cultura em fusões e aquisições
...
> Antes de fechar uma aquisição, o adquirente deve perguntar: "Se fôssemos descrever os comportamentos que essa empresa recompensa — não os valores declarados, mas o que de fato acontece — com quais dos nossos valores isso entra em conflito direto?" Conflito identificado antes é problema gerenciável. Conflito descoberto depois do fechamento é crise.
...
Em M&A: retention rate da empresa adquirida separado, nos primeiros doze meses. Alvo igual ou maior que oitenta por cento do headcount crítico identificado.
...
Assumir que remoto é igual a presencial com vídeo. As perdas culturais do trabalho distribuído exigem compensação ativa, não só ferramentas.
...
Ignorar cultura na due diligence de M&A. Conflito cultural identificado depois do fechamento custa muito mais do que identificado antes.
...
- [ ] Para times remotos ou híbridos: rituais síncronos não-opcionais existem?
- [ ] Para times remotos: offsite anual está no orçamento como prioridade?
- [ ] Em hipercrescimento: onboarding escalado antes de acelerar contratações?
- [ ] Em hipercrescimento: managers novos recebem treinamento de cultura antes de gerenciar?
- [ ] Brilliant jerks são endereçados com prazo definido — não tolerados indefinidamente?
- [ ] Hero culture diagnosticada e mitigada (nenhuma pessoa insubstituível sem plano)?
- [ ] Em M&A: diagnóstico cultural feito nos primeiros trinta dias pós-fechamento?
- [ ] Em M&A: retenção da empresa adquirida medida separadamente nos primeiros doze meses?
