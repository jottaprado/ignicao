---
title: "APÊNDICE AY — MARKETING DE PERFORMANCE EM PROFUNDIDADE"
appendix: "AY"
---
...
Canal emergente no Brasil com CPM significativamente mais baixo que Meta e Google em 2024-2025 — histórica janela de oportunidade antes que o canal madureça e os CPMs subam, como aconteceu com Instagram e Facebook entre 2016 e 2020.
...
Canal B2B por excelência. CPL (custo por lead) mais alto do mercado — tipicamente 5x a 10x o CPL do Meta — mas qualidade do lead é estruturalmente diferente. Segmentação por cargo, empresa, setor, senioridade e tamanho de empresa não existe em nenhuma outra plataforma com essa precisão.
...
- **Data-driven attribution (DDA)**: usa machine learning para atribuir crédito baseado em padrões reais de conversão nos dados da conta. Disponível no Google Ads e GA4 para contas com volume suficiente (mínimo ~3.000 conversões por mês). É o modelo mais preciso dos disponíveis dentro das plataformas.
...
Dado empírico consistente em múltiplas pesquisas da indústria: 70-80% da variância em performance de campanhas de social ads é explicada pelo criativo. O restante é targeting, bid e estrutura.
...
Marketing de performance está operando bem quando os seguintes itens estão em pé simultaneamente.

CAC por canal calculado e acompanhado com frequência mínima mensal, com separação clara entre canais pagos e canais orgânicos.

MER (Marketing Efficiency Ratio) do negócio acompanhado mensalmente como indicador integrador — não só ROAS por canal.

LTV/CAC calculado com dados reais de churn e cohort de pelo menos 6 meses de histórico, não com premissas teóricas.

Modelo de atribuição consciente documentado — a equipe sabe como os números são calculados e quais são as limitações.

Framework de creative testing ativo, com ao menos um teste em andamento a cada semana em canais de social ads.

Budget alocado com disciplina de explore/exploit — ao menos 20-30% em testes de novos canais, audiências ou formatos.

Incrementalidade testada em pelo menos um canal por trimestre, via holdout test ou equivalente.

Escala de budget feita gradualmente — sem saltos acima de 20-30% por semana — para preservar fase de aprendizado dos algoritmos.

### Checklist

- [ ] Métricas centrais definidas: CPA, CAC por canal, ROAS e MER calculados?
- [ ] CAC separado por canal (não só CAC blended)?
- [ ] Modelo de atribuição consciente documentado — não só last-click?
- [ ] MER total do negócio acompanhado mensalmente?
- [ ] Incrementalidade testada em pelo menos um canal por trimestre?
- [ ] Criativo refreshado a cada 2-4 semanas em campanhas ativas?
- [ ] Framework de creative testing ativo com hipóteses documentadas?
- [ ] Regra dos 20% de escala respeitada ao aumentar budget?
- [ ] LTV/CAC calculado com churn real de cohort — não LTV teórico?
- [ ] Meta Conversions API (CAPI) implementado server-side?
- [ ] Dados de conversão da plataforma triangulados com CRM?
- [ ] Landing pages avaliadas e otimizadas separadamente das campanhas?
- [ ] Para B2B: lista de contas-alvo definida para ABM?
- [ ] Budget de explore (30%) alocado para testes de novos canais?
- [ ] Critérios de sucesso definidos antes de contratar agência ou gestor de tráfego?
