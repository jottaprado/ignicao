---
title: "APÊNDICE EK — INFLUÊNCIA E PERSUASÃO SEM AUTORIDADE FORMAL"
appendix: "EK"
---
...
> O interlocutor para de fazer perguntas e começa a encerrar a conversa. Respostas ficam cada vez mais curtas. A objeção muda cada vez que você responde (não é sobre o que dizem que é). Tomador de decisão real parou de aparecer nas reuniões. Esses sinais indicam que a decisão já foi tomada — insistir queima capital de relacionamento para futuro.
...
[[apendice-ds|Apêndice DS — Negociação]], [[apendice-ej|Apêndice EJ — Tomada de Decisão]], [[apendice-ew|Apêndice EW — Comunicação Escrita]], [[apendice-ex|Apêndice EX — Apresentação]]
