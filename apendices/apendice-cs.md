---
title: "APÊNDICE CS — BOOTSTRAP vs VENTURE CAPITAL: A ESCOLHA FUNDACIONAL"
appendix: "CS"
---

## APÊNDICE CS — BOOTSTRAP vs VENTURE CAPITAL: A ESCOLHA FUNDACIONAL

A literatura de empreendedorismo tem viés forte para a narrativa do venture capital (capital de risco institucional). A maioria dos livros assume que você vai captar. Fala em termos de "rodada seed (semente)", "Série A", e "IPO (abertura de capital em bolsa) como exit (saída)". E apresenta bootstrapping (financiar com recursos próprios) como opção marginal. Ou como consolação para quem não conseguiu investidor. Esse apêndice inverte essa premissa. A decisão entre crescer com capital próprio (ou similar), e crescer com capital institucional externo, é uma das mais consequentes da trajetória. E fazê-la por default (padrão automático), "todo mundo capta, eu vou captar", produz erros caros, e crescimentos inadequados ao tipo de negócio.

Esse apêndice trata de bootstrap como opção séria. VC (venture capital) como opção séria. E de como decidir entre as duas com clareza. Em vez de por pressão social do ecossistema.
