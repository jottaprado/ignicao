---
title: "APÊNDICE DZ — COMUNICAÇÃO INTERNA"
appendix: "DZ"
---
...
> [!warning]
> Esconder informação crítica em all-hands não protege o time — protege a ansiedade da liderança. O time percebe a omissão, preenche a lacuna com rumor, e perde confiança na liderança. O custo de transparência é desconforto temporário. O custo da opacidade é desconfiança permanente.
...
> [!note]
> O maior erro em comunicação de RIF é não reconhecer a perda humana. Pessoas que saíram eram colegas. Dizer "desejamos sucesso a elas em suas próximas jornadas" sem reconhecer que a saída foi forçada soa cínico. Reconheça que é difícil. O time aguenta a honestidade — não aguenta a hipocrisia.
...
> [!warning]
> Comunicar "estamos investigando" sem dar horário de retorno cria um vácuo que o time preenche com ansiedade. Mesmo que a atualização em 2 horas seja "ainda estamos investigando", ela demonstra que a liderança está no controle do processo de comunicação, mesmo que ainda não esteja no controle do problema.
...
> [!important]
> Documentação só tem valor se for encontrável. Um Notion com 800 páginas sem estrutura de navegação é pior do que nenhum Notion — cria a ilusão de que a empresa documenta, quando na prática ninguém encontra nada. Defina uma estrutura de árvore antes de começar a documentar, e revise-a a cada 6 meses.
...
> [!important]
> Se a pesquisa de engajamento mostra que o time não confia na liderança ou não se sente seguro para dar feedback, o problema não é a pesquisa nem o time. O problema está no comportamento da liderança. Contratar um coach externo ou facilitador para conduzir as conversas difíceis pode ajudar a criar o espaço de segurança necessário.
...
> [!note]
> A transição mais crítica e menos antecipada é a de 50 para 100 pessoas. Nesse ponto, a empresa deixa de ser "todo mundo se conhece" e começa a ter subgrupos que não têm contato regular entre si. Culturas de produto e operações divergem. Times em cidades diferentes desenvolvem normas diferentes. Sem comunicação deliberada, a empresa começa a ter múltiplas culturas paralelas — e eventualmente conflitantes.
...
- [[apendice-da|Gestão de Pessoas e Performance]] — estrutura de 1:1s, ciclos de feedback e avaliação de desempenho que complementam os mecanismos de comunicação interna
- [[apendice-db|Cultura Organizacional e Valores]] — como os valores declarados se traduzem em comportamentos concretos de comunicação
- [[apendice-dc|Onboarding e Integração]] — como novos funcionários são introduzidos à cultura e aos mecanismos de comunicação da empresa
- [[apendice-ce|Gestão de Conflitos]] — protocolos para quando a comunicação interna falha e conflitos precisam ser tratados diretamente
- [[fases/fase-05|Fase 5 — Construção do Time]] — decisões de estrutura organizacional que determinam os fluxos de comunicação
- [[fases/fase-08|Fase 8 — Escala]] — como a comunicação interna evolui junto com a estrutura da empresa em crescimento acelerado
