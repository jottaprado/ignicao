---
title: "APÊNDICE FA — RELAÇÕES BANCÁRIAS E CRÉDITO NO BRASIL"
appendix: "FA"
---
...
> O erro mais comum em startups com fundador que acumulou savings pessoais antes de abrir a empresa é usar conta PF como caixa da empresa nos primeiros meses "para economizar tarifa". Esse erro tem custo alto: histórico bancário PJ zerado, potencial problema tributário, e risco de responsabilização pessoal em litígio futuro. Abra a conta PJ na semana em que o CNPJ é emitido. Transfira o capital inicial como integralização de capital, não como pró-labore.
...
- [[apendice-p|Apêndice P — Financiamento Não-Diluitivo]] para grants, Finep, FAPs e recursos públicos sem equity
- [[apendice-q|Apêndice Q — Precificação e Margens]] para entender como margem bruta afeta elegibilidade a crédito
- [[apendice-cb|Apêndice CB — Contabilidade e Gestão Financeira]] para estrutura de balanço que o banco analisa
- [[fases/fase-03|Fase 3 — Modelo de Negócio]] para entender quando faz sentido usar dívida vs equity em cada estágio
- [[apendice-cg|Apêndice CG — Simples Nacional e Tributação PJ]] para manter CNPJ regular como base do score bancário
