---
title: "APÊNDICE DY — BUSINESS DEVELOPMENT"
appendix: "DY"
---
...
A definição do ICP, feita na [[fases/fase-02|Fase 2 — Validação de Problema e Cliente]], é o insumo mais importante para qualificar parceiros. Sem ICP claro, o critério de "o parceiro tem os clientes que eu quero" não pode ser aplicado com rigor.

O modelo de receita e as métricas de unit economics, trabalhados na [[fases/fase-05|Fase 5 — Modelo de Negócio e Financeiro]], determinam qual percentual de revenue share é viável sem destruir a margem. Parceria com comissão de 25% só faz sentido se o CAC via canal for suficientemente menor que o CAC via força própria para compensar a margem cedida.

O processo de go-to-market estruturado, discutido na [[fases/fase-08|Fase 8 — Go-to-Market e Crescimento]], define quando a startup está pronta para escalar via canal. Ativar parceiros antes de ter playbook de vendas, materiais de enablement e suporte técnico estruturado é um dos erros mais comuns e mais custosos em BD.

---

**Ver também:**

- [[apendice-cz|Apêndice CZ — Canvases e Mapas Visuais]] — Canvas de Parceria para mapeamento visual do modelo de colaboração
- [[apendice-dx|Apêndice DX — Contratos para Startups]] — Estrutura jurídica de contratos de parceria, MOU e revenue share
- [[apendice-dz|Apêndice DZ — Vendas B2B]] — Playbook de vendas que o canal de parceiros vai usar
- [[fases/fase-05|Fase 5 — Modelo de Negócio]] — Unit economics e viabilidade do revenue share
- [[fases/fase-08|Fase 8 — Go-to-Market]] — Quando e como ativar canais de parceiros no plano de crescimento
