---
title: "APÊNDICE EO — CONTENCIOSO E LITÍGIO PARA STARTUPS"
appendix: "EO"
---
...
- [[apendice-eb|Apêndice EB — Contratos Essenciais para Startups]] — modelos de contrato que reduzem risco contratual na origem
- [[apendice-ec|Apêndice EC — Compliance Trabalhista e Gestão de Pessoas]] — estruturação da área de RH para evitar passivo
- [[apendice-ed|Apêndice ED — Planejamento Tributário para Startups]] — escolha de regime e gestão do risco fiscal
- [[apendice-ee|Apêndice EE — Proteção de Dados e LGPD]] — litígios regulatórios e responsabilidade por dados
- [[fases/fase-05|Fase 5 — Estrutura Jurídica e Societária]] — fundamentos da estruturação legal da empresa
- [[apendice-cz|Apêndice CZ — Canvases e Mapas Visuais]] — ferramentas de diagnóstico para mapeamento de risco operacional
