---
title: "APÊNDICE ED — COMPENSAÇÃO E BENEFÍCIOS NO BRASIL"
appendix: "ED"
---
...
> Relevante para [[apendice-el|Apêndice EL — Direito do Trabalho]], [[apendice-db|Apêndice DB — Stock Options e ESOP]], [[apendice-bz|Apêndice BZ — Performance Reviews]], [[apendice-co|Apêndice CO — Recrutamento Técnico]] e [[apendice-en|Apêndice EN — Tributário Estratégico]].
...
Cada componente resolve um problema diferente. Salário base paga as contas. Bônus variável alinha comportamento com resultados. Equity cria compromisso de longo prazo. Benefícios de saúde reduzem ansiedade e aumentam sensação de segurança. Flexibilidade muda a qualidade de vida.

Startups em estágio inicial têm menos dinheiro mas mais equity e mais flexibilidade. Empresas grandes têm mais dinheiro mas menos upside e menos autonomia. A proposta de valor deve ser honesta sobre isso — não fingir que o salário abaixo do mercado não existe, mas explicar por que o pacote completo faz sentido.

> [!important] A conversa de compensação é a conversa sobre o que você está comprando
> Quando a empresa define um pacote de compensação, está dizendo ao mercado de talentos o que valoriza e o que pode pagar. Um pacote incoerente — salário alto sem equity, equity sem explicação do que vale, benefícios aleatórios sem política — cria confusão. Coerência e transparência no pacote são vantagem competitiva.
...
> O mercado de tecnologia no Brasil tem volatilidade salarial alta — salários para engenheiros seniores subiram 40–60% entre 2020 e 2022, e ajustaram parcialmente em 2023–2024. Pesquisa de 2 anos atrás pode estar desatualizada. Calibrar com pelo menos uma fonte ao vivo (recrutador ativo no mercado) a cada ciclo de revisão salarial.
...
Ver [[apendice-db|Apêndice DB — Stock Options e ESOP]] para estruturação completa.
...
> Se a empresa paga "bônus" chamado de PLR sem o acordo formalizado na lei, a Receita Federal pode autuá-la cobrando INSS retroativo sobre todos os pagamentos. A isenção não é automática — depende do cumprimento do rito da Lei 10.101/2000. Formalizar o acordo antes do primeiro pagamento.
...
|---|---|---|
| Até 7.407,57 | Isento | — |
| De 7.407,58 a 9.922,28 | 7,5% | 555,57 |
| De 9.922,29 a 13.167,00 | 15% | 1.299,74 |
| De 13.167,01 a 16.380,38 | 22,5% | 2.287,49 |
| Acima de 16.380,38 | 27,5% | 3.106,53 |

(Valores de referência 2026 — atualizar com tabela vigente da Receita Federal.)
...
O mecanismo e a estrutura são cobertos em detalhe em [[apendice-db|Apêndice DB — Stock Options e ESOP]]. Neste apêndice, o foco é na integração com a estratégia de compensação total.
...
Desvantagem: tributado como remuneração no pagamento (IRRF + INSS) — sem o tratamento potencialmente mais favorável das opções reais. Ver [[apendice-db|Apêndice DB]] para detalhes.
...
- A tributação esperada no exercício e na venda (ver [[apendice-db|Apêndice DB]]).
...
PJ não tem relação de emprego — recebe opções ou phantom shares da mesma forma que um advisor: via contrato de prestação de serviços com cláusula de opção, não via plano de empregados CLT. A estrutura e o tratamento tributário são diferentes. Ver [[apendice-db|Apêndice DB]] e [[apendice-dj|Apêndice DJ]] para detalhes.
