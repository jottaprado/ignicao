---
title: "FASE 2 — ARTICULAÇÃO E CAPTURA DA IDEIA"
part: parte-i
---
...
flowchart LR
    ...
    C --> D["3) Estruturar em 7 blocos<br/>DII v1"]

    D --> B1["Problema<br/>3–5 frases + dados<br/>sem mencionar solução"]
    D --> B2["Para quem<br/>específico + filtros<br/>se B2B: Decisor + Champion"]
    D --> B3["Alternativa atual<br/>como resolvem hoje"]
    D --> B4["Solução proposta<br/>capacidades, não features"]
    D --> B5["Modelo de negócios<br/>quem paga, quanto, como"]
    D --> B6["Por que pode funcionar<br/>3–5 hipóteses de tese"]
    D --> B7["Por que nós<br/>FMF: vantagem injusta"]

    B1 & B2 & B3 & B4 & B5 & B6 & B7 --> E["4) Listar incertezas<br/>10–25 itens em 6 categorias<br/>(Demanda, Mercado, Solução,<br/>Adoção, Canal, Modelo)"]
    E --> F["5) Condensar em 1 página<br/>400–800 palavras"]
